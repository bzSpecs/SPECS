...
# python3 plot_relation.py results/TSC/threshold_3/rep1/all/by_promoter/threshold_3_TSC_rep1_all.csv 'Technical Repeat 1' results/TSC/threshold_3/rep2/all/by_promoter/threshold_3_TSC_rep2_all.csv 'Technical Repeat 2' 'TSC cells - all' promoter
# python3 plot_relation.py results/TSC/threshold_3/rep1/threshold_3_TSC_rep1_top_10_unique_promoters.csv 'Technical Repeat 1' results/TSC/threshold_3/rep2/threshold_3_TSC_rep2_top_10_unique_promoters.csv 'Technical Repeat 2' 'TSC cells - top 10' promoter
...
# python3 plot_relation.py results/ESC/threshold_3/rep1/all/by_promoter/threshold_3_ESC_rep1_all.csv 'Technical Repeat 1' results/ESC/threshold_3/rep2/all/by_promoter/threshold_3_ESC_rep2_all.csv 'Technical Repeat 2' 'ESC cells - all' promoter
# python3 plot_relation.py results/ESC/threshold_3/rep1/threshold_3_ESC_rep1_top_10_unique_promoters.csv 'Technical Repeat 1' results/ESC/threshold_3/rep2/threshold_3_ESC_rep2_top_10_unique_promoters.csv 'Technical Repeat 2' 'ESC cells - top 10' promoter
...
# python3 plot_relation.py results/MEFs/threshold_3/rep1/all/by_promoter/threshold_3_MEFs_rep1_all.csv 'Technical Repeat 1' results/MEFs/threshold_3/rep2/all/by_promoter/threshold_3_MEFs_rep2_all.csv 'Technical Repeat 2' 'MEFs cells - all' promoter
# python3 plot_relation.py results/MEFs/threshold_3/rep1/threshold_3_MEFs_rep1_top_10_unique_promoters.csv 'Technical Repeat 1' results/MEFs/threshold_3/rep2/threshold_3_MEFs_rep2_top_10_unique_promoters.csv 'Technical Repeat 2' 'MEFs cells - top 10' promoter
...
# python3 plot_relation.py results/XEN/threshold_3/rep1/all/by_promoter/threshold_3_XEN_rep1_all.csv 'Technical Repeat 1' results/XEN/threshold_3/rep2/all/by_promoter/threshold_3_XEN_rep2_all.csv 'Technical Repeat 2' 'XEN cells - all' promoter
# python3 plot_relation.py results/XEN/threshold_3/rep1/threshold_3_XEN_rep1_top_10_unique_promoters.csv 'Technical Repeat 1' results/XEN/threshold_3/rep2/threshold_3_XEN_rep2_top_10_unique_promoters.csv 'Technical Repeat 2' 'XEN cells - top 10' promoter
...
# python3 plot_relation.py results/HEK293T/threshold_3/rep1/all/by_promoter/threshold_3_HEK293T_rep1_all.csv 'Technical Repeat 1' results/HEK293T/threshold_3/rep2/all/by_promoter/threshold_3_HEK293T_rep2_all.csv 'Technical Repeat 2' 'HEK293T cells - all' promoter
# python3 plot_relation.py results/HEK293T/threshold_3/rep1/threshold_3_HEK293T_rep1_top_10_unique_promoters.csv 'Technical Repeat 1' results/HEK293T/threshold_3/rep2/threshold_3_HEK293T_rep2_top_10_unique_promoters.csv 'Technical Repeat 2' 'HEK293T cells - top 10' promoter
