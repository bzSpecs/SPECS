...
python $pyscripts_folder/calculate_ratio_between_columns.py $avg_unique_17_count_output_file count number_of_barcodes avg_count_per_number_of_barcodes "" 0 10 $avg_unique_17_count_output_file
...
python $pyscripts_folder/calculate_ratio_between_columns.py $avg_normalized_unique_17_count_output_file count number_of_barcodes avg_count_per_number_of_barcodes "" 0 10 $avg_normalized_unique_17_count_output_file
