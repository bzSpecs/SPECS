...
second_df = second_df[[based_which_column] + columns_to_merge]
...
# join
df = main_df.set_index(based_which_column).join(
    second_df.set_index(based_which_column), how=join_type).reset_index()
