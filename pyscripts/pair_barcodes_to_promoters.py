...
#%%
df_r1 = pd.read_csv(mapped_file, sep="\t", header=None, names=["id_",'promoter'], index_col=0)
...
# %%
print("No barcode: {}, No promoter: {}".format(df_out['barcode'].isna().sum(),
                                               df_out['promoter'].isna().sum()))
