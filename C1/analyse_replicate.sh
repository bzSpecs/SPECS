...
python $pyscripts_folder/normalize_column_by_reads.py $unique_17_count_output_file $cleaned_raw_paired_csv_file count 10000 $normalized_unique_17_count_output_file
...
python $pyscripts_folder/normalize_column_by_reads.py $unique_17_barcode_count_output_file $cleaned_raw_paired_csv_file count 10000 $normalized_unique_17_barcode_count_output_file
